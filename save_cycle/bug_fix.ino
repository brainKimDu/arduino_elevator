...
void upstairs(int floor_up){
  ...
  floor_location--;
    ...
    if(floor_location == 10 ){
      if ((instruct_sunseo +1) == 3 ){
        if(push_floor_list[0] == 2 ){
          push_floor_list[0] = 4;
          order_sunseo = instruct_sunseo+1;
          if(order_sunseo == 3)
            order_sunseo = 0;
          push_floor = 3;
        }      
      }
      else if (push_floor_list[instruct_sunseo + 1] == 2){
        push_floor_list[instruct_sunseo+1] = 4;
        order_sunseo = instruct_sunseo+1;
        if(order_sunseo == 3)
          order_sunseo = 0;
        push_floor = 3;
